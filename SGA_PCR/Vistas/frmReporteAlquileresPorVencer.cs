...
namespace Apolo
{
    public partial class frmReporteAlquileresPorVencer : Form
    {
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Estas seguro que desea Exportar el reporte", "◄ AVISO | LEASEIN S.A.C. ►", MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    MessageBox.Show("Error al exportar la informacion | Si tiene un reporte de ALQUILER POR VENCER ya abierto, cierrelo.", " ◄ AVISO | LEASEIN S.A.C. ►", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                }
        ...
        int posY = 0;
        int posX = 0;
        private void pnlLV_MouseMove(object sender, MouseEventArgs e)
        {

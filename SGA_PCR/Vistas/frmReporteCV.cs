...
namespace Apolo
{
    public partial class frmReporteCV : Form
    {
        ...
        void options_CustomizeSheetHeader(DevExpress.Export.ContextEventArgs e)
        {
            ...
            e.ExportContext.MergeCells(new DevExpress.Export.Xl.XlCellRange(new DevExpress.Export.Xl.XlCellPosition(0, 0), new DevExpress.Export.Xl.XlCellPosition(28, 1))); //EL 18 SON LAS COLUMNAS QUE TIENE EL REPORTE
        }

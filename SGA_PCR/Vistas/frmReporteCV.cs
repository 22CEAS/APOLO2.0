...
namespace Apolo
{
    public partial class frmReporteCV : Form
    {
        ...
        void options_CustomizeSheetHeader(DevExpress.Export.ContextEventArgs e)
        {
            ...
            e.ExportContext.MergeCells(new DevExpress.Export.Xl.XlCellRange(new DevExpress.Export.Xl.XlCellPosition(0, 0), new DevExpress.Export.Xl.XlCellPosition(29, 1))); //EL 18 SON LAS COLUMNAS QUE TIENE EL REPORTE
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Estas seguro que desea Exportar el reporte", "◄ AVISO | LEASEIN ►", MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    //MessageBox.Show("Error al exportar la informacion | Si tiene un CUADRO DE VENCIMIENTO ya abierto, cierrelo."," ◄ AVISO | LEASEIN ►", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                }

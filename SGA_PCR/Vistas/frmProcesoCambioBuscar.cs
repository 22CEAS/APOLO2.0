    ...
    public partial class frmProcesoCambioBuscar : Form
    {
        ...
        private void cargarDataGridView()
        {
            ...
            else if (rbtnNumCambio.Checked)
            {
                ...
                {
                    MessageBox.Show("El numero de Cambio no es valido", "◄ AVISO | LEASEIN ►", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
        ...
        private void btnSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se ha seleccionado ningun Cambio", "◄ AVISO | LEASEIN ►", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            Cursor.Current = Cursors.Default;
        }

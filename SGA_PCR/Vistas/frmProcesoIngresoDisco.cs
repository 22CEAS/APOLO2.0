...
namespace Apolo
{
    public partial class frmProcesoIngresoDisco : Form
    {
        ...
        {
            if (MessageBox.Show("Estas seguro deseas Agregar estos discos", "◄ AVISO | LEASEIN ►", MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
            {

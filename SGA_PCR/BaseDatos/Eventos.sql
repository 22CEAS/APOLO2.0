...
#Posteriormente creamos nuestro evento; En mi caso, tendrá el nombre de insertion event. Este evento se 
#ejecutará dentro de 1 min, y lo que hará, será insertar un registro en mi tabla.
...
#Si queremos que el evento se ejecute en una fecha en concreto, únicamente debemos de especificarlo en 
#ON SCHEDULE AT. Recuerda, el formato es año-mes-día hora:minuto:
ON SCHEDULE AT '2018-12-31 12:00:00';segundo.
